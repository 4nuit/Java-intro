...
public interface Set<E> extends Collection<E>
{
		...
		NullPointerException, ClassCastException
	{
		...
		Class<? extends E > typeElts = elementsType();
		for (Iterator<?> it = c.iterator(); it.hasNext();) {
			Object o = it.next();
			
			if (typeElts.isInstance(o)) {
				throw new ClassCastException("Incompatible type"+o.getClass().getSimpleName());
	...
	public default boolean isEmpty()
	{
		...
		Iterator<E> iterator = iterator();
		//Set à 2 éléments , ne marche pas
		...
		NullPointerException, ClassCastException
	{
		...
		//throw new ClassCastException(" is not a valid class");
